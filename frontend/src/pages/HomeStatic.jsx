...
import { usePortfolioData, useBlogData } from '../hooks/useLocalData';

const HomeStatic = () => {
  const { data: portfolioData, loading: portfolioLoading } = usePortfolioData();
  const { posts: blogPosts, loading: blogLoading } = useBlogData();
  ...
  const { personal, academic, achievements, research } = portfolioData;
